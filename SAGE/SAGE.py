...
from .preprocess import preprocess_adj, get_feature, fix_seed, preprocess_adj
...
class SAGE():
    ...
    def train(self, epochs_t=None):
        ...
        for epoch in epoch_bar:
            ...
            self.loss_KL = self.swav_loss(
                results['emb_latent_coord'],
    ...
    def get_dynamic_weights(self, epoch, max_epoch=300):
        """Dynamic weight calculation by phase"""
